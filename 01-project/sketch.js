...
function addEye() {
  size = random(minimumEyeSize, maximumEyeSize);
  speed = random(minimumEyeSpeed, maximumEyeSpeed);
  distanceEyeFromCenter = 120 - (size * 10 - 1) * 15;
  size = size * WIDTH;
  randomeEyeX = WIDTH + size;
  randomeEyeY = random(size / 4, HEIGHT - size / 4);
  r = random(0, 255);
  g = random(0, 255);
  b = random(0, 255);
  a = 255;
